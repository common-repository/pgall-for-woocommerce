...
if ( ! class_exists( 'PAFW_Settings_Nicepay_SamsungPay' ) ) {
	class PAFW_Settings_Nicepay_SamsungPay extends PAFW_Settings_Nicepay {
			...
			return array (
				array (
					...
					'elements' => array (
						...
						array (
							'id'        => 'nicepay_samsungpay_description',
							'title'     => '결제수단 설명',
							'className' => 'fluid',
							'type'      => 'TextArea',
							'default'   => '삼성페이로 결제합니다.',
				...
				array (
					...
					'elements' => array (
						array (
							'id'        => 'nicepay_samsungpay_use_advanced_setting',
							'title'     => '사용',
							'className' => '',
							'type'      => 'Toggle',
							'default'   => 'no',
						...
						array (
							'id'        => 'nicepay_samsungpay_order_status_after_payment',
							'title'     => __( '결제완료시 변경될 주문상태', 'pgall-for-woocommerce' ),
							'showIf'    => array ( 'nicepay_samsungpay_use_advanced_setting' => 'yes' ),
							'className' => '',
							'type'      => 'Select',
							'default'   => 'processing',
						...
						array (
							'id'        => 'nicepay_samsungpay_possible_refund_status_for_mypage',
