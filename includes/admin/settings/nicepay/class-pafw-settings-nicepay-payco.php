...
if ( ! class_exists( 'PAFW_Settings_Nicepay_Payco' ) ) {
	class PAFW_Settings_Nicepay_Payco extends PAFW_Settings_Nicepay {
		...
		function get_setting_fields() {
			return array (
				...
				array (
					...
					'elements' => array (
						array (
							'id'        => 'nicepay_payco_use_advanced_setting',
							'title'     => '사용',
							'className' => '',
							'type'      => 'Toggle',
							'default'   => 'no',
						...
						array (
							'id'        => 'nicepay_payco_order_status_after_payment',
							'title'     => __( '결제완료시 변경될 주문상태', 'pgall-for-woocommerce' ),
							'showIf'    => array ( 'nicepay_payco_use_advanced_setting' => 'yes' ),
							'className' => '',
							'type'      => 'Select',
							'default'   => 'processing',
						...
						array (
							'id'        => 'nicepay_payco_possible_refund_status_for_mypage',
