...
if ( ! class_exists( 'PAFW_Settings_TossPayments_SamsungPay' ) ) {

	class PAFW_Settings_TossPayments_SamsungPay extends PAFW_Settings_TossPayments {
		...
		function get_setting_fields() {
			return array (
				array (
					...
					'elements' => array (
						array (
							'id'        => 'tosspayments_samsungpay_title',
							'title'     => '결제수단 이름',
							'className' => 'fluid',
							'type'      => 'Text',
							'default'   => '삼성페이',
						...
						array (
							'id'        => 'tosspayments_samsungpay_description',
							'title'     => '결제수단 설명',
							'className' => 'fluid',
							'type'      => 'TextArea',
							'default'   => "삼성페이로 결제합니다.",
				...
				array (
					...
					'elements' => array (
						array (
							'id'        => 'tosspayments_samsungpay_use_advanced_setting',
							'title'     => '사용',
							'className' => '',
							'type'      => 'Toggle',
							'default'   => 'no',
						...
						array (
							'id'        => 'tosspayments_samsungpay_order_status_after_payment',
							'title'     => __( '결제완료시 변경될 주문상태', 'pgall-for-woocommerce' ),
							'showIf'    => array ( 'tosspayments_samsungpay_use_advanced_setting' => 'yes' ),
							'className' => '',
							'type'      => 'Select',
							'default'   => 'processing',
						...
						array (
							'id'        => 'tosspayments_samsungpay_possible_refund_status_for_mypage',
