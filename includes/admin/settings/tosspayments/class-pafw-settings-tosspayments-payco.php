...
if ( ! class_exists( 'PAFW_Settings_TossPayments_Payco' ) ) {

	class PAFW_Settings_TossPayments_Payco extends PAFW_Settings_TossPayments {
			...
			return array (
				array (
					...
					'elements' => array (
						...
						array (
							'id'        => 'tosspayments_payco_description',
							'title'     => '결제수단 설명',
							'className' => 'fluid',
							'type'      => 'TextArea',
				...
				array (
					...
					'elements' => array (
						array (
							'id'        => 'tosspayments_payco_use_advanced_setting',
							'title'     => '사용',
							'className' => '',
							'type'      => 'Toggle',
							'default'   => 'no',
						...
						array (
							'id'        => 'tosspayments_payco_order_status_after_payment',
							'title'     => __( '결제완료시 변경될 주문상태', 'pgall-for-woocommerce' ),
							'showIf'    => array ( 'tosspayments_payco_use_advanced_setting' => 'yes' ),
							'className' => '',
							'type'      => 'Select',
							'default'   => 'processing',
						...
						array (
							'id'        => 'tosspayments_payco_possible_refund_status_for_mypage',
