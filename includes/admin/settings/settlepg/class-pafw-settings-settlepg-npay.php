...
if ( ! class_exists( 'PAFW_Settings_SettlePG_NPay' ) ) {
	class PAFW_Settings_SettlePG_NPay extends PAFW_Settings_SettlePG {
			...
			return array (
				...
				array (
					...
					'elements' => array (
						...
						array (
							'id'        => 'settlepg_npay_order_status_after_payment',
							'title'     => __( '결제완료시 변경될 주문상태', 'pgall-for-woocommerce' ),
							'showIf'    => array ( 'settlepg_npay_use_advanced_setting' => 'yes' ),
							'className' => '',
							'type'      => 'Select',
							'default'   => 'processing',
						...
						array (
							'id'        => 'settlepg_npay_possible_refund_status_for_mypage',
