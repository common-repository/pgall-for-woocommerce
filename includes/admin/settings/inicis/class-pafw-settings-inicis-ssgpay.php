...
if ( ! class_exists( 'PAFW_Settings_Inicis_SSGPay' ) ) {
	class PAFW_Settings_Inicis_SSGPay extends PAFW_Settings_Inicis {
		function get_setting_fields() {
			return array(
				array(
					...
					'elements' => array(
						array(
							'id'        => 'inicis_ssgpay_title',
							'title'     => '결제수단 이름',
							'className' => 'fluid',
							'type'      => 'Text',
							'default'   => __( "SSG Pay", "pgall-for-woocommerce" ),
							'tooltip'   => array(
								'title' => array(
						...
						array(
							'id'        => 'inicis_ssgpay_description',
							'title'     => '결제수단 설명',
							'className' => 'fluid',
							'type'      => 'TextArea',
							'default'   => __( 'SSG Pay로 결제합니다.', 'pgall-for-woocommerce' ),
							'tooltip'   => array(
								'title' => array(
				...
				array(
					'type'     => 'Section',
					'title'    => __( "SSG Pay 고급 설정", "pgall-for-woocommerce" ),
					'elements' => array(
						array(
							'id'        => 'inicis_ssgpay_use_advanced_setting',
							'title'     => '사용',
							'className' => '',
							'type'      => 'Toggle',
							'default'   => 'no',
						...
						array(
							'id'        => 'inicis_ssgpay_order_status_after_payment',
							'title'     => __( '결제완료시 변경될 주문상태', 'pgall-for-woocommerce' ),
							'showIf'    => array( 'inicis_ssgpay_use_advanced_setting' => 'yes' ),
							'className' => '',
							'type'      => 'Select',
							'default'   => 'processing',
						...
						array(
							'id'        => 'inicis_ssgpay_possible_refund_status_for_mypage',
