...
if ( ! class_exists( 'PAFW_Settings_Inicis_NPay' ) ) {
	class PAFW_Settings_Inicis_NPay extends PAFW_Settings_Inicis {
			...
			return array(
				...
				array(
					...
					'elements' => array(
						...
						array(
							'id'        => 'inicis_npay_order_status_after_payment',
							'title'     => __( '결제완료시 변경될 주문상태', 'pgall-for-woocommerce' ),
							'showIf'    => array( 'inicis_npay_use_advanced_setting' => 'yes' ),
							'className' => '',
							'type'      => 'Select',
							'default'   => 'processing',
						...
						array(
							'id'        => 'inicis_npay_possible_refund_status_for_mypage',
