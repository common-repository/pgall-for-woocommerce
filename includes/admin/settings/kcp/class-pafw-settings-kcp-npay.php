...
if ( ! class_exists( 'PAFW_Settings_Kcp_NPay' ) ) {
	class PAFW_Settings_Kcp_NPay extends PAFW_Settings_Kcp {
		...
		function get_setting_fields() {
			return array (
				...
				array (
					...
					'elements' => array (
						array (
							'id'        => 'kcp_npay_use_advanced_setting',
							'title'     => '사용',
							'className' => '',
							'type'      => 'Toggle',
							'default'   => 'no',
						...
						array (
							'id'        => 'kcp_npay_order_status_after_payment',
							'title'     => __( '결제완료시 변경될 주문상태', 'pgall-for-woocommerce' ),
							'showIf'    => array ( 'kcp_npay_use_advanced_setting' => 'yes' ),
							'className' => '',
							'type'      => 'Select',
							'default'   => 'processing',
						...
						array (
							'id'        => 'kcp_npay_possible_refund_status_for_mypage',
