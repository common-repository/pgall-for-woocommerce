...
if ( class_exists( 'WC_Payment_Gateway' ) ) {
	...
	if ( ! class_exists( 'WC_Gateway_TossPayments_LPay' ) ) {

		class WC_Gateway_TossPayments_LPay extends WC_Gateway_TossPayments {

			public function __construct() {
				$this->id = 'tosspayments_lpay';

				parent::__construct();

				if ( empty( $this->settings['title'] ) ) {
					$this->title       = __( 'LPay', 'pgall-for-woocommerce' );
