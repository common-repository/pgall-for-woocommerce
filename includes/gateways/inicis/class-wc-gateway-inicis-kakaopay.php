...
if ( class_exists( 'WC_Gateway_Inicis_KakaoPay' ) ) {
	return;
}

class WC_Gateway_Inicis_KakaoPay extends WC_Gateway_Inicis {

	public function __construct() {
		$this->id = 'inicis_kakaopay';
